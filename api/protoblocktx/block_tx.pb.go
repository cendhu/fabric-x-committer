...
var (
	file_api_protoblocktx_block_tx_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
	file_api_protoblocktx_block_tx_proto_msgTypes  = make([]protoimpl.MessageInfo, 18)
	file_api_protoblocktx_block_tx_proto_goTypes   = []interface{}{
