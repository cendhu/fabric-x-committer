...
type (
	...
	// on dead connections fail instead of hanging indefinitely.
	deadlineConn struct {
		net.Conn
...
// ConfigurePoolConnHealth configures the pool to detect dead connections
...
func ConfigurePoolConnHealth(poolConfig *pgxpool.Config) {
	dialer := &net.Dialer{
